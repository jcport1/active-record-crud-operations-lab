...
def can_be_created_with_a_hash_of_attributes
  ...
  movie = Movie.create(attributes) #use create & pass in the hash
end

def can_be_created_in_a_block(args = {title: "Home Alone", release_date: 1990}) #insert hash with key/values for default
  # If no arguments are passed, use default values:
  # title == "Home Alone"
  # release_date == 1990
  
  Movie.create do |m|
    m.title = args[:title] #set attribute = to hash key
